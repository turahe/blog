...
handler.on('push', function (event) {
  ...
  execFile(
    '/home/default/deploy/boilerplate/deploy.sh',
    execOptions,
...
> **Catatan:** _Jika Anda mengalami service time out di Gitlab hooks, kemungkinan besar adalah Anda tidak memasang port
> di VPS Anda atau port Anda pasang salah. Mohon dicek lebih teliti lagi._
