  ...
  webServer: process.env.PLAYWRIGHT_SKIP_WEBSERVER
    ...
    : {
        ...
        env: {
          ...
          MOCK_STORAGE_DIR: process.env.MOCK_STORAGE_DIR || '.ci-storage',
          MOCK_STORAGE_PUBLIC_URL: process.env.MOCK_STORAGE_PUBLIC_URL || 'https://storage.ci.test',
          MOCK_STORAGE_BUCKET: process.env.MOCK_STORAGE_BUCKET || 'blog-media',
        },
      },
