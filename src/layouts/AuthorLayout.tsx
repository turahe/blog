...
import type { AuthorCore, ExperienceItem } from '@/types/post'
    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:space-y-0 xl:gap-x-8">
        ...
        <div className="prose dark:prose-invert max-w-none pt-8 pb-8 xl:col-span-2">
          <div>
            <p>
              Building products at the intersection of AI and fintech has been my recent focus— from
              deploying ML-powered risk engines to experimenting with LLM-assisted onboarding flows
              that improve compliance and reduce friction for users.
            </p>
            <p>
              Experienced programmer with a strong background in software development and a passion
              for problem-solving. Proficient in designing, coding, testing, and maintaining
              software applications. Adept at collaborating with cross-functional teams to deliver
              high-quality solutions. Specialized web development and mobile app development.
            </p>
          </div>
          <br />
          <p className="sm:block md:hidden lg:hidden">
            ...
            actively on the wrote books in the fields of programming, data science and electricity.
          </p>
          ...
          <p>
            ...
            projects with new people. Feel free to reach out if you have anything to talk about, you
