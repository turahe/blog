...
import type { ExperienceItem } from '@/types/post'

const Experience = ({ title, company, location, range, url, text }: ExperienceItem) => {
  return (
    <div className="my-3">
        ...
        <div className="p-2">
          {text.map((el: string, index: number) => (
            <div className="flex flex-row" key={index}>
              <div className="text-primary-color-500 mr-2 text-lg"> &#8227;</div>
